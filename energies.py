...
from analytics import Eu_lambdified, Ev_lambdified, B_lambdified
...
if __name__ == '__main__':
    ...
    for i in range(NU):
        ...
        for j in range(NV):
            ...
            dA[i,j] = du*dv * h**2
    plt.imshow(electric_energy_density * dA)
    plt.show()
    ...
    arr = np.array([electric_energy, magnetic_energy, hydraulic_energy, total_energy])
    np.save(sys.argv[1] + '_energies.npy', arr)